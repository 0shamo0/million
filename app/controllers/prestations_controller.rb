class PrestationsController < ApplicationController
  ...
  def index 
    if current_user.admin == true
        ...
        @prestations = current_user.prestations.all
      end
  ...
  def create
    ...
    @prestation = current_user.prestations.new(prestation_params)
  ...
  private
    ...
    def prestation_params
      params.require(:prestation).permit(:designation, :prix, :reduction, :user_id)
    end
end
