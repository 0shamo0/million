...
class PrestationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prestation" do
    assert_difference('Prestation.count') do
      post prestations_url, params: { prestation: { designation: @prestation.designation, prix: @prestation.prix, reduction: @prestation.reduction } }
    end
  ...
  test "should update prestation" do
    patch prestation_url(@prestation), params: { prestation: { designation: @prestation.designation, prix: @prestation.prix, reduction: @prestation.reduction } }
